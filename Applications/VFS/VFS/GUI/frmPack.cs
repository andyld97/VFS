...
namespace VFS.GUI
{
    public partial class frmPack : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            VFS currentSystem = new VFS(string.Empty, path, currentSettings.MainCounter, currentSettings.PackByte);
        ...
        private void btnResearch_Click(object sender, EventArgs e)
        {
            ...
            using (SaveFileDialog sfd = new SaveFileDialog())
            {
                if (sfd.ShowDialog(this) == DialogResult.OK)
                    this.txtPath.Text = (!sfd.FileName.EndsWith(".vhp") ? sfd.FileName + ".vhp" : sfd.FileName);
            }
        }
