...
using VFS;
using VFS.GUI.Tab.Dialog.AddFolderDirectoryDialog;
using VFS.Interfaces;

namespace VFS.GUI.Tab.Dialog.AddFolderDirectoryDialog
{
    public partial class AddFolderDirectoryDialog : Form
    {
        ...
        public AddFolderDirectoryDialog(bool isFile, IDirectory currentDir, VFS currentFS)
        {
            InitializeComponent();
