// ------------------------------------------------------------------------
// Element.cs written by Code A Software (http://www.code-a-software.net)
// All rights reserved
...
namespace VFS.Application.GUI.Tab
{
    public class Element
    {
        ...
        public static void Select(List<Element> lst, Element cElement, bool multipleSelect = false, bool select = false)
        {
            if (!multipleSelect)
            {
                foreach (Element cur in lst)
